        ...
        return Scaffold(
          ...
          body: Stack(
            children: [
              ...
              if (!_showIntro && _questions.isNotEmpty) _OrbBackground(dimension: _questions[_currentIndex].dimension),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(color: Colors.white.withOpacity(0.25), blurRadius: 40, offset: const Offset(0, 12)),
                ],
              ),
              child: const Center(
                child: Row(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Text(
              label,
              style: TextStyle(color: Colors.white.withOpacity(0.35), fontSize: 10, fontWeight: FontWeight.w700),
            ),
          ],
        ),
      ),
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        theme.label,
                        style: TextStyle(color: theme.primary, fontSize: 12, fontWeight: FontWeight.w800),
                      ),
                    ],
                  ),
                ),
        ...
        Padding(
          ...
          child: Row(
            children: List.generate(_questions.length, (i) {
              Color c;
              if (i < _currentIndex)
                c = theme.primary.withOpacity(0.7);
              else if (i == _currentIndex)
                c = theme.primary;
              else
                c = Colors.white.withOpacity(0.08);
              return Expanded(
                child: Container(
                  height: 4,
...
class _OrbBackgroundState extends State<_OrbBackground> with SingleTickerProviderStateMixin {
  ...
  double _sin(double x) =>
      (x % (2 * 3.14159) < 3.14159) ? (x % 3.14159 / 3.14159) * 2 - 1 : 1 - (x % 3.14159 / 3.14159) * 2;
...
Widget _glassBox({
  ...
  final decoration = BoxDecoration(color: color, borderRadius: borderRadius, border: border, boxShadow: boxShadow);
  if (kIsWeb) {
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              _sub,
              textAlign: TextAlign.center,
              style: TextStyle(color: Colors.grey[400], fontSize: 14, height: 1.55),
            ),
