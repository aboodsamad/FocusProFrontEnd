        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Center(
                  child: Text(
                    ...
                    style: const TextStyle(color: AppColors.onPrimary, fontSize: 26, fontWeight: FontWeight.w900),
                  ),
                ),
              ),
              ...
              Text(
                _questions.isNotEmpty && _score >= (_questions.length * 0.7).ceil()
                ...
                child: Stack(
                  children: [
                    ...
                    FractionallySizedBox(
                      ...
                      child: AnimatedContainer(duration: const Duration(milliseconds: 800), color: _timerColor),
                    ),
                  ],
                ),
              ),
                            ...
                            child: AnimatedContainer(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  if (isSelected) const Icon(Icons.check_circle, color: AppColors.onPrimary, size: 20),
                                ],
                              ),
                            ),
                          );
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        color: _selected == -1 ? AppColors.surfaceContainerHigh : AppColors.primary,
                        borderRadius: BorderRadius.circular(999),
                      ),
                      child: Text(
                        _qIndex < _questions.length - 1 ? 'Continue' : 'Finish',
                        style: TextStyle(
                          color: _selected == -1 ? AppColors.onSurfaceVariant : AppColors.onPrimary,
                          fontSize: 15,
                          fontWeight: FontWeight.w700,
                        ),
                      ),
