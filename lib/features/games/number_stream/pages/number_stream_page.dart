...
class _NumberStreamPageState extends State<NumberStreamPage> with TickerProviderStateMixin {
  // ── Game state ──────────────────────────────────────────────────────────────
  ...
  void initState() {
    ...
    _fallCtrl = AnimationController(vsync: this, duration: const Duration(milliseconds: 5200))
      ..addStatusListener(_onFallStatus);

    _burstCtrl = AnimationController(vsync: this, duration: const Duration(milliseconds: 650))
      ..addStatusListener((s) {
    ...
    _levelCtrl = AnimationController(vsync: this, duration: const Duration(milliseconds: 500));
  }
  ...
  void _startGame() {
    ...
    setState(() {
      _game = NumberStreamState.initial().copyWith(level: widget.startLevel, phase: NumberStreamPhase.countdown);
      _cdValue = 3;
      _particles.clear();
    });
    _runCountdown();
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        body: AnimatedBuilder(
          animation: Listenable.merge([_fallCtrl, _burstCtrl, _shakeCtrl, _pulseCtrl, _levelCtrl, _cdCtrl]),
          builder: (context, _) {
                      ...
                      child: LayoutBuilder(
                        builder: (ctx, box) {
                          ...
                          return Stack(
                            ...
                            children: [
                              // Ambient background
                              Positioned.fill(child: CustomPaint(painter: _BgPainter(_pulseCtrl.value))),
                              // Falling equation
                              ...
                              // Streak badge
                              if (_game.streak >= 2 && _game.phase == NumberStreamPhase.playing) _buildStreakBadge(),
                              // Overlays
                              if (_game.phase == NumberStreamPhase.idle) _buildIdleOverlay(),
                              if (_game.phase == NumberStreamPhase.countdown) _buildCountdownOverlay(),
                              if (_game.phase == NumberStreamPhase.levelUp) _buildLevelUpOverlay(),
                              if (_game.phase == NumberStreamPhase.gameOver) _buildGameOverOverlay(),
                              // Particles
                              if (_particles.isNotEmpty)
                                Positioned.fill(
                                  child: CustomPaint(painter: _ParticlePainter(_particles, _burstCtrl.value)),
                                ),
                            ],
                          );
                        },
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            child: Text(
              'LVL ${_game.level}',
              style: const TextStyle(color: _kAccent, fontWeight: FontWeight.w800, fontSize: 13),
            ),
          ),
          ...
          Column(
            ...
            children: [
              Text(
                '${_game.score}',
                style: const TextStyle(color: _kText, fontWeight: FontWeight.w900, fontSize: 22),
              ),
              Text(
                'SCORE',
                style: TextStyle(color: _kMuted, fontSize: 9, fontWeight: FontWeight.w700, letterSpacing: 1.5),
              ),
            ],
          ),
        ],
                  ...
                  AnimatedFractionallySizedBox(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        color: _kAccent,
                        borderRadius: BorderRadius.circular(6),
                        boxShadow: [BoxShadow(color: _kAccent.withOpacity(0.5), blurRadius: 6)],
                      ),
                    ),
                  ),
                ],
      ...
      child: Center(
        child: Container(
          ...
          child: Row(
            ...
            children: [
              const Icon(Icons.local_fire_department_rounded, color: _kGold, size: 16),
              const SizedBox(width: 5),
              Text(
                '${_game.streak}× streak',
                style: const TextStyle(color: _kGold, fontWeight: FontWeight.w700, fontSize: 13),
              ),
            ],
          ),
        ),
        ...
        child: Center(
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(color: borderCol.withOpacity(0.55), blurRadius: 32, spreadRadius: 3),
                BoxShadow(color: borderCol.withOpacity(0.18), blurRadius: 80),
                BoxShadow(color: AppColors.onPrimary.withOpacity(0.04), blurRadius: 0, spreadRadius: -1),
              ],
            ),
            child: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                Text(
                  ...
                  style: TextStyle(
                    ...
                    letterSpacing: 2,
                    shadows: [Shadow(color: borderCol.withOpacity(0.8), blurRadius: 20)],
                  ),
                ),
                ...
                Text(
                  ...
                  style: TextStyle(
                    ...
                    shadows: [Shadow(color: borderCol.withOpacity(0.6), blurRadius: 10)],
                  ),
                ),
              ],
            ),
  ...
  Widget _buildAnswerSection(BuildContext context) {
    ...
    final show = _game.phase == NumberStreamPhase.playing || (_game.phase == NumberStreamPhase.levelUp && _feedback);
        ...
        child: GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: border != _kBorder ? [BoxShadow(color: border.withOpacity(0.35), blurRadius: 14)] : [],
            ),
            child: Center(
              child: Text(
                '$choice',
                style: TextStyle(color: textColor, fontSize: fontSize, fontWeight: FontWeight.w900, letterSpacing: 0.5),
              ),
            ),
          ),
        ),
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [BoxShadow(color: _kAccent.withOpacity(0.45), blurRadius: 36)],
                  ),
                  child: const Icon(Icons.functions_rounded, color: AppColors.primary, size: 44),
                ),
                const SizedBox(height: 24),
                const Text(
                  'Number Stream',
                  style: TextStyle(color: _kText, fontSize: 30, fontWeight: FontWeight.w900, letterSpacing: -0.5),
                ),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(color: _kAccent.withOpacity(0.45), blurRadius: 28, offset: const Offset(0, 10)),
                      ],
                    ),
                    child: const Text(
                      'PLAY',
                ...
                child: Transform.scale(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      ...
                      fontSize: 88,
                      fontWeight: FontWeight.w900,
                      shadows: [Shadow(color: (_cdValue == 0 ? _kCorrect : _kAccent).withOpacity(0.6), blurRadius: 30)],
                    ),
                  ),
                ),
              );
          ...
          child: Center(
            child: ScaleTransition(
              ...
              child: Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                  const Icon(Icons.arrow_circle_up_rounded, color: _kGold, size: 64),
                  ...
                  const SizedBox(height: 10),
                  Text(_levelFlavour(_game.level), style: TextStyle(color: _kMuted, fontSize: 16)),
                ],
              ),
            ),
          ),
  ...
  String _levelFlavour(int level) {
    switch (level) {
      case 2:
        return 'Subtraction unlocked!';
      case 3:
        return 'Numbers getting bigger…';
      case 4:
        return 'Multiplication unlocked!';
      case 5:
        return 'Mixed operations  stay sharp!';
      default:
        return 'Equations are falling faster!';
    }
  }
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: const Icon(Icons.sentiment_dissatisfied_rounded, color: _kWrong, size: 40),
                ),
                const SizedBox(height: 18),
                const Text(
                  'Game Over',
                  style: TextStyle(color: _kText, fontSize: 34, fontWeight: FontWeight.w900),
                ),
                const SizedBox(height: 28),
                // Stats card
                Container(
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: const Center(
                            child: Text(
                              'Exit',
                              style: TextStyle(color: _kMuted, fontSize: 16, fontWeight: FontWeight.w700),
                            ),
                          ),
                        ),
                      ),
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: AppColors.secondaryContainer,
                            borderRadius: BorderRadius.circular(16),
                            boxShadow: [BoxShadow(color: _kAccent.withOpacity(0.38), blurRadius: 18)],
                          ),
                          child: const Center(
                            child: Text(
                              'Play Again',
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(color: _kAccentDim, borderRadius: BorderRadius.circular(8)),
            child: Text(
              level,
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        Text(
          label,
          style: const TextStyle(color: _kMuted, fontSize: 15, fontWeight: FontWeight.w500),
        ),
        Text(
          value,
          style: TextStyle(
...
class _ParticlePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    for (final p in particles) {
      ...
      canvas.drawCircle(Offset(x, y), radius, Paint()..color = p.color.withOpacity(opacity));
    }
  }
    ...
    canvas.drawCircle(
      ...
      Paint()
        ..shader = RadialGradient(
          colors: [AppColors.secondaryContainer.withOpacity(0.045 + pulse * 0.018), Colors.transparent],
