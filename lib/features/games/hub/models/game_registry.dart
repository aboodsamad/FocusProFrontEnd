...
class GameRegistry {
  ...
  static const List<GameItem> all = [
    GameItem(
      ...
      title: 'Memory Matrix',
      description:
          'A grid lights up with a pattern  memorise it, then recreate it from memory. Patterns grow harder as you level up.',
    ...
    GameItem(
      ...
      title: 'Sudoku',
      description:
          'Fill every row, column and 3×3 box with the digits 1–9. No repeats allowed. Choose Easy, Medium or Hard.',
    ...
    GameItem(
      ...
      title: 'Speed Match',
      description:
          'Does the card on screen match the one before it? Tap Yes or No as fast as you can before the timer runs out.',
    ...
    GameItem(
      ...
      title: 'Color Match',
      description:
          'Tap the button whose color matches the meaning of the word  not the color the word is printed in. Classic Stroop effect.',
    ...
    GameItem(
      ...
      title: 'Number Stream',
      description:
          'Equations fall from the top of the screen. Solve them before they hit the bottom  speed and accuracy both count.',
    ...
    GameItem(
      ...
      title: 'Pattern Trail',
      description:
          'Dots appear one by one across the screen. Remember the sequence and tap them back in the exact same order.',
    ...
    GameItem(
      ...
      description:
          'Trains speed toward stations  tap junctions to switch the tracks and route each train to its matching colored station before it crashes.',
    ...
    GameItem(
      ...
      title: 'Visual N-Back',
      description:
          'A cell lights up in a 3×3 grid. Remember which '
    ...
    GameItem(
      ...
      title: 'Go/No-Go',
      description:
          'Tap the green circle fast. Never tap the red one. '
    ...
    GameItem(
      ...
      title: 'Flanker Task',
      description:
          'Five arrows appear. Respond to the CENTER arrow '
  ...
  static List<GameItem> get hubGames => all.where((g) => !_dailyOnlyIds.contains(g.id)).toList();

  static List<GameItem> byCategory(GameCategory category) => hubGames.where((g) => g.category == category).toList();

  static List<GameItem> get available => hubGames.where((g) => g.isAvailable).toList();
