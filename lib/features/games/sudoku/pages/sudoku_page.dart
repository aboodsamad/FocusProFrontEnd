...
class _SudokuHomePageState extends State<SudokuHomePage> with SingleTickerProviderStateMixin {
  // ── Game state ─────────────────────────────────────────────────────────────
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: const Icon(Icons.emoji_events_rounded, color: AppColors.primary, size: 36),
              ),
              ...
              const Text(
                'Great job keeping focused',
                style: TextStyle(color: AppColors.onSurfaceVariant, fontSize: 13),
              ),
              const SizedBox(height: 20),
              const Divider(color: AppColors.outlineVariant),
              const SizedBox(height: 16),
              SudokuStatRow(icon: Icons.timer_outlined, label: 'Time', value: _formatTime(seconds)),
              SudokuStatRow(icon: Icons.error_outline_rounded, label: 'Mistakes', value: mistakes.toString()),
              SudokuStatRow(icon: Icons.lightbulb_outline_rounded, label: 'Hints', value: hintsUsed.toString()),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('New Game', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
                ),
              ),
              const SizedBox(height: 10),
              TextButton(
                onPressed: () => Navigator.pop(context),
                child: const Text('Close', style: TextStyle(color: AppColors.onSurfaceVariant, fontSize: 13)),
              ),
            ],
          ),
        ),
  ...
  int get _selectedValue => (selectedRow != null && selectedCol != null) ? board[selectedRow!][selectedCol!] : 0;
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    SudokuInfoCard(icon: Icons.timer_outlined, text: _formatTime(seconds)),
                    ...
                    SudokuInfoCard(
                      ...
                      iconColor: mistakes > 0 ? AppColors.error : AppColors.onSurfaceVariant,
                    ),
                  ],
                ),
              ),
              ...
              Container(
                ...
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    SudokuNumberPad(board: board, selectedValue: _selectedValue, onNumberPressed: _placeNumber),
